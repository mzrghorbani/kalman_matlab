 ...
 * only. Not for sale.
 * File: _coder_MatrixR_fixpt_api.c
 *
...
#include "_coder_MatrixR_fixpt_mex.h"
...
static void MatrixR_fixpt_once(const emlrtStack *sp);
...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *H, const
...
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *St, const
  char_T *identifier, int16_T y[8]);
...
static void g_emlrt_marshallIn(const mxArray *src, uint16_T ret[4]);
...
static void MatrixR_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx, b_numerictype(sp, "FractionLength", -1.0,
    "BinaryPoint", -1.0, "Slope", 2.0, "FixedExponent", 1.0, &emlrtMCI));
  emlrtAssignP(&c_eml_mx, c_numerictype(sp, "WordLength", 11.0, "FractionLength",
  ...
  char_T *identifier, int16_T y[8])
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(H), &thisId, y);
  emlrtDestroyArray(&H);
}
  ...
  char_T *identifier, int16_T y[8])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  f_emlrt_marshallIn(sp, emlrtAlias(St), &thisId, y);
  ...
  real_T pb, const char * qb, real_T rb, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m4, 42, pArrays, "fimath", true, location);
}
 ...
 * Return Type  : void
 */
void MatrixR_fixpt_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[1])
{
  uint16_T V[4];
  int16_T H[8];
  ...
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "H", H);
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "St", St);

  /* Invoke the target function */
  MatrixR_fixpt(V, H, St, Rmat);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, Rmat);
}
 ...
 * Return Type  : void
 */
void MatrixR_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixR_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixR_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixR_fixpt_api.c
 *
 * [EOF]
 */
