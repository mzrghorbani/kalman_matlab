...
#include "main.h"
#include "VectorRes_fixpt_terminate.h"
#include "VectorRes_fixpt_initialize.h"

// Function Declarations
static void argInit_2x1_sfix13(short result[2]);
...
static void main_VectorRes_fixpt();
...
static void argInit_4x1_sfix16_En3(short result[4])
{
  ...
  // Set the value of the array element.
  // Change this value to the value that the application requires.
  result[2] = argInit_sfix13();

  // Set the value of the array element.
  // Change this value to the value that the application requires.
  result[3] = argInit_sfix13();
}
...
static void main_VectorRes_fixpt()
{
  ...
  // Initialize function 'VectorRes_fixpt' input arguments.
  // Initialize function input argument 'm'.
  // Initialize function input argument 'H'.
  // Initialize function input argument 'x'.
  // Call the entry-point 'VectorRes_fixpt'.
  argInit_2x1_sfix13(iv0);
  argInit_8x1_sfix11(iv1);
  argInit_4x1_sfix16_En3(iv2);
  VectorRes_fixpt(iv0, iv1, iv2, res);
}
