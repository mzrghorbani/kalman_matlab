 ...
 * only. Not for sale.
 * File: _coder_VectorRes_fixpt_api.c
 *
...
static void VectorRes_fixpt_once(const emlrtStack *sp);
...
static void g_emlrt_marshallIn(const mxArray *src, int16_T ret[2]);
static void h_emlrt_marshallIn(const mxArray *src, int16_T ret[8]);
static void i_emlrt_marshallIn(const mxArray *src, int16_T ret[4]);
...
static void VectorRes_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&e_eml_mx, numerictype(sp, "FractionLength", 9.0, "BinaryPoint",
    9.0, "Slope", 0.001953125, "FixedExponent", -9.0, &emlrtMCI));
  emlrtAssignP(&d_eml_mx, numerictype(sp, "FractionLength", 3.0, "BinaryPoint",
    3.0, "Slope", 0.125, "FixedExponent", -3.0, &emlrtMCI));
  emlrtAssignP(&c_eml_mx, b_numerictype(sp, "WordLength", 11.0, "FractionLength",
  ...
  i, const char * j, real_T k, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m2, 10, pArrays, "numerictype", true,
    location);
}
...
static void g_emlrt_marshallIn(const mxArray *src, int16_T ret[2])
{
  ...
  r0 = (int16_T (*)[2])emlrtMxGetData(mxInt);
  ret[0] = (*r0)[0];
  ret[1] = (*r0)[1];
...
static void i_emlrt_marshallIn(const mxArray *src, int16_T ret[4])
{
  ...
  int16_T (*r2)[4];
  mxInt = emlrtImportFiIntArrayR2008b(src);
  r2 = (int16_T (*)[4])emlrtMxGetData(mxInt);
  ret[0] = (*r2)[0];
  ret[1] = (*r2)[1];
  ret[2] = (*r2)[2];
  ret[3] = (*r2)[3];
 ...
 * Return Type  : void
 */
void VectorRes_fixpt_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[1])
{
  int16_T m[2];
  int16_T H[8];
  ...
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "x", x);

  /* Invoke the target function */
  VectorRes_fixpt(m, H, x, res);
 ...
 * Return Type  : void
 */
void VectorRes_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void VectorRes_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void VectorRes_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_VectorRes_fixpt_api.c
 *
 * [EOF]
 */
