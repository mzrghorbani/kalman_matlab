 ...
 * Return Type  : void
 */
void MatrixH_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                 *plhs[1])
{
  real_T (*H)[8];
  real_T r;
  ...
  H = (real_T (*)[8])mxMalloc(sizeof(real_T [8]));
...
/*
 * File trailer for _coder_MatrixH_api.c
 *
 * [EOF]
 */
