 ...
 * Return Type  : void
 */
  void MatrixR_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray
                   *plhs[1])
{
  real_T (*Rmat)[4];
  real_T (*V)[4];
  ...
  Rmat = (real_T (*)[4])mxMalloc(sizeof(real_T [4]));

  /* Marshall function inputs */
  V = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "V");
  H = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "H");
  St = c_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "St");

  /* Invoke the target function */
  MatrixR(*V, *H, *St, *Rmat);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Rmat);
}
...
/*
 * File trailer for _coder_MatrixR_api.c
 *
 * [EOF]
 */
