...
static void main_MatrixS()
{
  ...
  // Initialize function 'MatrixS' input arguments.
  // Initialize function input argument 'H'.
  // Initialize function input argument 'C'.
  // Call the entry-point 'MatrixS'.
  argInit_8x1_real_T(dv0);
  argInit_16x1_real_T(dv1);
  MatrixS(dv0, dv1, S);
}
