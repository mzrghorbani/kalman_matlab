 ...
 * only. Not for sale.
 * File: _coder_PitchOverR_fixpt_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "PitchOverR_fixpt",                  /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void PitchOverR_fixpt_once(const emlrtStack *sp);
...
static uint16_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *r, const
  char_T *identifier);
static uint16_T d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static uint16_T e_emlrt_marshallIn(const mxArray *src);
static uint16_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *pitch,
...
static void PitchOverR_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "FractionLength", 14.0, "BinaryPoint", 14.0, "Slope",
    6.103515625E-5, "FixedExponent", -14.0, &emlrtMCI));
  ...
  emlrtAssignP(&b_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "FractionLength", 6.0, "BinaryPoint", 6.0, "Slope", 0.015625,
    "FixedExponent", -6.0, &emlrtMCI));
  ...
  const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = b_emlrt_marshallIn(sp, emlrtAlias(pitch), &thisId);
 ...
 * Return Type  : void
 */
void PitchOverR_fixpt_api(const mxArray * const prhs[2], int32_T nlhs, const
  mxArray *plhs[1])
{
  uint16_T pitch;
  uint16_T r;
  ...
  pitch = emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "pitch");
  r = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "r");

  /* Invoke the target function */
  pitch = PitchOverR_fixpt(pitch, r);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, pitch);
}
 ...
 * Return Type  : void
 */
void PitchOverR_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  PitchOverR_fixpt_xil_terminate();
 ...
 * Return Type  : void
 */
void PitchOverR_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void PitchOverR_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_PitchOverR_fixpt_api.c
 *
 * [EOF]
 */
