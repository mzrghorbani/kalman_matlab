...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("MatrixC"));
...
/*
 * File trailer for _coder_MatrixC_info.c
 *
 * [EOF]
 */
