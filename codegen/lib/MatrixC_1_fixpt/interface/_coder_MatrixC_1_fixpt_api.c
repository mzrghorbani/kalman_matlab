 ...
 * only. Not for sale.
 * File: _coder_MatrixC_1_fixpt_api.c
 *
...
#include "_coder_MatrixC_1_fixpt_mex.h"
...
static void MatrixC_1_fixpt_once(const emlrtStack *sp);
...
static void g_emlrt_marshallIn(const mxArray *src, int16_T ret[16]);
...
static void MatrixC_1_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx, numerictype(sp, "FractionLength", 2.0, "BinaryPoint",
...
static void g_emlrt_marshallIn(const mxArray *src, int16_T ret[16])
{
  ...
  r0 = (int16_T (*)[16])emlrtMxGetData(mxInt);
  for (i = 0; i < 16; i++) {
    ret[i] = (*r0)[i];
  }
 ...
 * Return Type  : void
 */
void MatrixC_1_fixpt_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[1])
{
  int16_T C[16];
  int16_T K[8];
  ...
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "S", S);

  /* Invoke the target function */
  MatrixC_1_fixpt(C, K, S, C_new);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, C_new);
}
 ...
 * Return Type  : void
 */
void MatrixC_1_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixC_1_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixC_1_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixC_1_fixpt_api.c
 *
 * [EOF]
 */
