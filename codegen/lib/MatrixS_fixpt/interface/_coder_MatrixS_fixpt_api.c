 ...
 * only. Not for sale.
 * File: _coder_MatrixS_fixpt_api.c
 *
...
static void MatrixS_fixpt_once(const emlrtStack *sp);
...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *C, const
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *H, const
  char_T *identifier, int16_T y[8]);
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const int16_T u[8]);
static void f_emlrt_marshallIn(const mxArray *src, int16_T ret[16]);
...
static void MatrixS_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&c_eml_mx, numerictype(sp, "FractionLength", -1.0, "BinaryPoint",
    -1.0, "Slope", 2.0, "FixedExponent", 1.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx, b_numerictype(sp, "WordLength", 11.0, "FractionLength",
  ...
  char_T *identifier, int16_T y[8])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(H), &thisId, y);
  emlrtDestroyArray(&H);
}
...
static void f_emlrt_marshallIn(const mxArray *src, int16_T ret[16])
{
  ...
  int32_T i;
  mxInt = emlrtImportFiIntArrayR2008b(src);
  r1 = (int16_T (*)[16])emlrtMxGetData(mxInt);
  for (i = 0; i < 16; i++) {
    ret[i] = (*r1)[i];
  }
 ...
 * Return Type  : void
 */
void MatrixS_fixpt_api(const mxArray * const prhs[2], int32_T nlhs, const
  mxArray *plhs[1])
{
  int16_T H[8];
  int16_T C[16];
  ...
  emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "H", H);
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "C", C);

  /* Invoke the target function */
  MatrixS_fixpt(H, C, S);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, S);
}
 ...
 * Return Type  : void
 */
void MatrixS_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixS_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixS_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixS_fixpt_api.c
 *
 * [EOF]
 */
