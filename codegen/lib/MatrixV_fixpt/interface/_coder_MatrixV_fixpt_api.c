 ...
 * only. Not for sale.
 * File: _coder_MatrixV_fixpt_api.c
 *
...
static void MatrixV_fixpt_once(const emlrtStack *sp);
...
static int16_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *z, const
  char_T *identifier);
static const mxArray *c_numerictype(const emlrtStack *sp, const char * b, real_T
  c, const char * d, real_T e, const char * f, real_T g, const char * h, real_T
...
static uint16_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *inv2R,
  const char_T *identifier);
static uint16_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *r, const
  char_T *identifier);
...
static int16_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *tanL,
  const char_T *identifier);
...
static void MatrixV_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&f_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "FractionLength", 4.0, "BinaryPoint", 4.0, "Slope", 0.0625,
    "FixedExponent", -4.0, &emlrtMCI));
  emlrtAssignP(&e_eml_mx, b_numerictype(sp, "FractionLength", 13.0,
  ...
  emlrtAssignP(&d_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "FractionLength", 13.0, "BinaryPoint", 13.0, "Slope",
    0.0001220703125, "FixedExponent", -13.0, &emlrtMCI));
  emlrtAssignP(&c_eml_mx, c_numerictype(sp, "WordLength", 13.0, "FractionLength",
    0.0, "BinaryPoint", 0.0, "Slope", 1.0, "FixedExponent", 0.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx, d_numerictype(sp, "SignednessBool", false,
    "Signedness", "Unsigned", "WordLength", 10.0, "FractionLength", 0.0,
  ...
  char * n, real_T o, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m4, 14, pArrays, "numerictype", true,
    location);
}
  ...
  const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(inv2R), &thisId);
  ...
  const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = h_emlrt_marshallIn(sp, emlrtAlias(tanL), &thisId);
 ...
 * Return Type  : void
 */
void MatrixV_fixpt_api(const mxArray * const prhs[4], int32_T nlhs, const
  mxArray *plhs[1])
{
  uint16_T r;
  int16_T z;
  ...
  inv2R = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "inv2R");
  tanL = g_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "tanL");

  /* Invoke the target function */
  MatrixV_fixpt(r, z, inv2R, tanL, V);
 ...
 * Return Type  : void
 */
void MatrixV_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixV_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixV_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixV_fixpt_api.c
 *
 * [EOF]
 */
