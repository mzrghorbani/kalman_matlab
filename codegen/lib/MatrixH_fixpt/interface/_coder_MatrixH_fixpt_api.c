 ...
 * only. Not for sale.
 * File: _coder_MatrixH_fixpt_api.c
 *
...
#include "_coder_MatrixH_fixpt_mex.h"
...
static void MatrixH_fixpt_once(const emlrtStack *sp);
...
static uint16_T c_emlrt_marshallIn(const mxArray *src);
...
static void MatrixH_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&c_eml_mx, numerictype(sp, "WordLength", 11.0, "FractionLength",
 ...
 * Return Type  : void
 */
void MatrixH_fixpt_api(const mxArray * const prhs[1], int32_T nlhs, const
  mxArray *plhs[1])
{
  uint16_T r;
  int16_T H[8];
 ...
 * Return Type  : void
 */
void MatrixH_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixH_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MatrixH_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixH_fixpt_api.c
 *
 * [EOF]
 */
