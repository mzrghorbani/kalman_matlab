 ...
 * only. Not for sale.
 * File: _coder_MatrixS_transpose_fixpt_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "MatrixS_transpose_fixpt",           /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void MatrixS_transpose_fixpt_once(const emlrtStack *sp);
static void b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, int16_T y[8]);
static void c_emlrt_marshallIn(const mxArray *src, int16_T ret[8]);
 ...
 * Return Type  : void
 */
void MatrixS_transpose_fixpt_api(const mxArray * const prhs[1], int32_T nlhs,
  const mxArray *plhs[1])
{
  int16_T S[8];
  int16_T St[8];
  ...
  MatrixS_transpose_fixpt(S, St);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, St);
}
 ...
 * Return Type  : void
 */
void MatrixS_transpose_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  MatrixS_transpose_fixpt_xil_terminate();
 ...
 * Return Type  : void
 */
void MatrixS_transpose_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    MatrixS_transpose_fixpt_once(&st);
  }
}
 ...
 * Return Type  : void
 */
void MatrixS_transpose_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MatrixS_transpose_fixpt_api.c
 *
 * [EOF]
 */
