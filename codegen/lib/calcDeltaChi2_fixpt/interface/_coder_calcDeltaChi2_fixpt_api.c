 ...
 * only. Not for sale.
 * File: _coder_calcDeltaChi2_fixpt_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "calcDeltaChi2_fixpt",               /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void calcDeltaChi2_fixpt_once(const emlrtStack *sp);
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, uint16_T y[4]);
static void e_emlrt_marshallIn(const mxArray *src, int16_T ret[2]);
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *res, const
...
static void calcDeltaChi2_fixpt_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx, numerictype(sp, "SignednessBool", false, "Signedness",
    "Unsigned", "FractionLength", 17.0, "BinaryPoint", 17.0, "Slope",
    7.62939453125E-6, "FixedExponent", -17.0, &emlrtMCI));
  ...
  emlrtAssignP(&b_eml_mx, b_numerictype(sp, "FractionLength", 9.0, "BinaryPoint",
  ...
  char_T *identifier, int16_T y[2])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(res), &thisId, y);
 ...
 * Return Type  : void
 */
void calcDeltaChi2_fixpt_api(const mxArray * const prhs[2], int32_T nlhs, const
  mxArray *plhs[1])
{
  int16_T res[2];
  uint16_T RmatInv[4];
  ...
  emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "res", res);
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "RmatInv", RmatInv);

  /* Invoke the target function */
  dChi2 = calcDeltaChi2_fixpt(res, RmatInv);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, dChi2);
}
 ...
 * Return Type  : void
 */
void calcDeltaChi2_fixpt_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  calcDeltaChi2_fixpt_xil_terminate();
 ...
 * Return Type  : void
 */
void calcDeltaChi2_fixpt_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calcDeltaChi2_fixpt_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_calcDeltaChi2_fixpt_api.c
 *
 * [EOF]
 */
